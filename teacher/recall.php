...
<html lang="en">
    ...
    <body class="#c8e6c9 green lighten-4">
        <div class="container">
            <div class="row">
              <nav class="nav-wrapper black" style="height:150px">
                <div class="col s12" style="text-align:center">
                  <h3 style= "font-size:50px; font-family:Noto Sans TC,sans-serif;">學生名單</h3>
                </div>
              </nav>
            </div>
            <div class="row"> 
                <table class="striped">
                    <tr>
                        ...
                        <th style="text-align:center; font-size:20px;font-family:Noto Sans TC,sans-serif;">x</th>
                        <th style="text-align:center; font-size:20px;font-family:Noto Sans TC,sans-serif;">y</th>
                    </tr>
                    <?php
                        foreach($data as $row){
                            echo"<tr >";
            ...
            <!--<div class="row"> 
                <div class="col s12">
                    <a style= "font-size:20px; font-family:Noto Sans TC,sans-serif;" class="btn waves-effect col s6 offset-m4 m4 blue-grey lighten-4 black-text" href="./teacher.php"><h6>回到主畫面</h6></a>
                </div>
            </div>-->
        </div>
    </body>
